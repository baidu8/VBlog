<template>
    <div>
        <section class="page-header">
            ...
            <a href="https://drive.uusb.cf" class="btn" target="_blank">云盘</a>
            <a :href="'https://github.com/'+githubUsername" class="btn" target="_blank" v-if="!mini">GitHub</a>
            <a href="https://nav.uusb.cf" class="btn" target="_blank" v-if="!mini">导航</a>
        </section>
                    ...
                    <el-col :span="10">
                        <el-menu @select="selectTopbar" :default-active="topbar.active" mode="horizontal" menu-trigger="click">
                            <el-submenu index="#more">
                                ...
                                <el-menu-item index="#githubHome">github</el-menu-item>
...
<style>
    .page-header {
        ...
        background: url(https://note.youdao.com/yws/api/personal/file/WEBc01a7e16a207f0a401b77846e1c38644?method=download&shareKey=1707539a369fc6cee2d21b0bf9c76c0b) center center / cover no-repeat;
    }
